...
class ChiPhiThucTe {
    ...
    // Lấy chi phí theo tour_id
    public function findByTourId($tourId) {
        $sql = "SELECT * FROM chi_phi_thuc_te WHERE tour_id = ? ORDER BY ngay_phat_sinh DESC";
    ...
    public function getByDuToan($duToanId) {
        $sql = "SELECT cp.*, t.ten_tour, nd_ghi.ho_ten as nguoi_ghi_nhan, nd_duyet.ho_ten as nguoi_duyet
