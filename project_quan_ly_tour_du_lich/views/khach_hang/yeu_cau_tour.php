        ...
        <div class="row g-0 align-items-stretch">
                ...
                <div class="form-section">
                    ...
                    <form method="POST" action="index.php?act=khachHang/guiYeuCauTour">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="dia_diem" required class="form-control">
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="so_nguoi" min="1" required class="form-control">
                        </div>
                        <div class="form-group mb-3">
                            <label class="fw-bold">Yêu cầu đặc biệt:</label>
                            <textarea name="yeu_cau_dac_biet" rows="3" class="form-control"></textarea>
                        </div>
            ...
            <div class="col-lg-5 split-col ps-lg-4 mt-4 mt-lg-0">
                <div class="list-section h-100 d-flex flex-column">
                    <h2 class="text-success"><i class="bi bi-list-check me-2"></i>Yêu cầu chờ xác nhận</h2>
                    <div class="list-scroll flex-grow-1">
                            ...
                            <ul class="list-group">
                                <?php foreach ($allYeuCau as $yc): ?>
                                    <?php
                                        ...
                                        $isConfirmed = ($yc['trang_thai'] === 'DaGui' && isset($yc['xac_nhan_admin']) && $yc['xac_nhan_admin'] == 1);
                                    ?>
                                    <li class="list-group-item d-flex flex-column align-items-start">
                                        <div><span class="list-label">Địa điểm:</span> <span class="list-value"><?php echo htmlspecialchars($parts['Địa điểm'] ?? ''); ?></span></div>
                                        <div><span class="list-label">Thời gian:</span> <span class="list-value"><?php echo htmlspecialchars($parts['Thời gian'] ?? ''); ?></span></div>
                                        <div><span class="list-label">Số người:</span> <span class="list-value"><?php echo htmlspecialchars($parts['Số người'] ?? ''); ?></span></div>
                                        ...
                                        <div class="text-secondary small mt-1"><i class="bi bi-clock"></i> Gửi lúc: <?php echo htmlspecialchars($yc['created_at'] ?? ''); ?></div>
                                        <div class="mt-2">
                                            <?php if ($yc['trang_thai'] === 'DaGui'): ?>
                                                <span class="badge bg-success px-3 py-1">Chờ xác nhận</span>
                                            <?php else: ?>
                                                <span class="badge bg-warning text-dark px-3 py-1">Chờ xác nhận</span>
                                            <?php endif; ?>
                                        </div>
                                    </li>
                                <?php endforeach; ?>
                        ...
                        <?php else: ?>
                            <div class="text-muted">Bạn chưa có yêu cầu nào.</div>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
