                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <a href="index.php?act=admin/lichSuXoaBooking" class="btn btn-outline-danger btn-sm mt-2">
                           ...
                           <a href="index.php?act=admin/yeuCauTour" class="btn btn-light border border-warning rounded-pill px-4 py-2 mt-2 ms-2 d-inline-flex align-items-center" style="color:#856404;font-weight:500;font-size:1rem;transition:background 0.2s,box-shadow 0.2s;box-shadow:0 2px 8px rgba(255,193,7,0.08);" onmouseover="this.style.background='#fffbe6';this.style.boxShadow='0 4px 16px rgba(255,193,7,0.18)';" onmouseout="this.style.background='';this.style.boxShadow='0 2px 8px rgba(255,193,7,0.08)';">
                               <i class="bi bi-envelope-paper me-2"></i> Xem yêu cầu tour khách gửi
                           </a>
                    </div>
