<?php
// File: views/admin/cong_no_nha_cung_cap.php
// Hiển thị trạng thái thanh toán, còn nợ, chi tiết từng lần thanh toán cho từng đơn vị cung ứng
?>
<!DOCTYPE html>
<html lang="vi">
<head>
            ...
            <div class="col-lg-10">
                <div class="card mb-4">
                    <div class="card-header bg-info text-white">
                        <h4 class="mb-0"><i class="bi bi-building"></i> Công nợ nhà cung cấp</h4>
                    </div>
                    <div class="card-body p-0">
                        <?php if (!empty($congNoNhaCungCap)) { ?>
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                <?php foreach ($congNoNhaCungCap as $item): ?>
                                    <tr>
                                        <td><?= htmlspecialchars($item['ten_nha_cung_cap']) ?></td>
                                        <td><?= htmlspecialchars($item['ten_dich_vu']) ?></td>
                                        <td>
                        ...
                        <?php } else { ?>
                            <div class="p-4 text-center text-muted">
                                ...
                                <p class="mt-3">Không có dữ liệu công nợ nhà cung cấp.</p>
                            </div>
                        <?php } ?>
                    </div>
                </div>
                <div class="text-center">
                    <a href="index.php?act=admin/baoCaoTaiChinh" class="btn btn-outline-info">
