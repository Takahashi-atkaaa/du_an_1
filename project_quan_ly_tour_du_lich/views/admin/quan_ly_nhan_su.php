                        ...
                        <?php if (!empty($nhan_su_list)): ?>
                            <?php foreach ($nhan_su_list as $nhan_su): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($nhan_su['vai_tro'] ?? ''); ?></td>
                                    ...
                                    <td class="table-actions">
                                        <button class="btn btn-sm btn-primary btn-edit" 
                                            ...
                                            >Sửa</button>
                                            <a href="index.php?act=admin/nhanSu_delete&id=<?php echo $nhan_su['nhan_su_id']; ?>" class="btn btn-sm btn-warning" onclick="return confirm('Xóa nhân sự này? (Tài khoản sẽ được giữ)');">Xóa NV</a>
                                            <a href="index.php?act=admin/nhanSu_delete&id=<?php echo $nhan_su['nhan_su_id']; ?>&delete_user=1" class="btn btn-sm btn-danger" onclick="return confirm('XÓA VĨ VIỄN: Nhân sự này và tài khoản liên kết sẽ bị xóa. Bạn chắc chắn?');">Xóa All</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
                ...
                <div class="row g-3">
                    <div class="col-md-12" id="userSelectWrapper">
                        <label class="form-label">Chọn người dùng *</label>
                        <select name="nguoi_dung_id" id="nguoi_dung_id" class="form-select" required>
                            <option value="">-- Chọn người dùng --</option>
                        </select>
                        <small class="form-text text-muted">Chỉ hiển thị tài khoản chưa có hồ sơ nhân sự</small>
                    </div>
                    <div class="col-md-12" id="userInfoDisplay" style="display:none;">
                        <label class="form-label">Người dùng</label>
                        <input type="text" id="userInfoText" class="form-control" readonly>
                        <small class="form-text text-muted">Không thể thay đổi người dùng khi sửa nhân sự</small>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <label class="form-label">Sức khoẻ</label>
                        <input name="suc_khoe" id="suc_khoe" class="form-control">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Chứng chỉ</label>
                        <textarea name="chung_chi" id="chung_chi" class="form-control" rows="2"></textarea>
                    </div>
                    <div class="col-md-6">
