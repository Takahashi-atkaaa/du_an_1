...
<body>
    <div class="admin-container">
        ...
        <div class="content">
            ...
            <!-- Form thêm nhân sự -->
            <form method="POST" action="index.php?act=tour/phanBoNhanSuLichKhoiHanh" style="margin-bottom: 20px; padding: 15px; background: #f8f9fa; border-radius: 4px;">
                    ...
                    <tbody>
                        <?php foreach ($phanBoNhanSu as $pb): ?>
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="index.php?act=tour/updateTrangThaiNhanSuLichKhoiHanh" style="display: inline;">
            ...
            <!-- Form thêm dịch vụ -->
            <form method="POST" action="index.php?act=tour/phanBoDichVuLichKhoiHanh" style="margin-bottom: 20px; padding: 15px; background: #f8f9fa; border-radius: 4px;">
                <input type="hidden" name="lich_khoi_hanh_id" value="<?php echo $lichKhoiHanh['id']; ?>">
                <input type="hidden" name="tour_id" value="<?php echo $tour['tour_id']; ?>">
                <table>
                    <tr>
                    ...
                    <tbody>
                        <?php foreach ($phanBoDichVu as $pb): ?>
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="index.php?act=tour/updateTrangThaiDichVuLichKhoiHanh" style="display: inline;">
                                        <input type="hidden" name="id" value="<?php echo $pb['id']; ?>">
                                        <input type="hidden" name="lich_khoi_hanh_id" value="<?php echo $lichKhoiHanh['id']; ?>">
                                        <input type="hidden" name="tour_id" value="<?php echo $tour['tour_id']; ?>">
