        ...
        <div class="row mb-4">
            <div class="col-md-4">
                <a href="index.php?act=hdv/luongThuong" class="feature-card">
                    <div class="card-bg-image" style="background-image: url('https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=400');"></div>
                    <div class="feature-icon bg-success bg-opacity-10 text-success mx-auto">
                        <i class="bi bi-wallet2"></i>
                    </div>
                    <h5 class="text-center mb-2">Lương & Thưởng</h5>
                    <p class="text-center text-muted mb-0 small">
                        Xem lương, thưởng và hoa hồng của bạn
                    </p>
                </a>
            </div>
            <div class="col-md-4">
